...
public class Pruebas {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("CONSULTAR PRESTAMOS POR IDE>>>>>>>>>>>>>>>>>>>>>>>>>");
			ArrayList<Prestamo> prestamos=AdminServicios.mostrarPrestamosID(2);
			if(prestamos.size()!=0) {
			...
			System.out.println("CONSULTAR LIBRO LIBRO X NOMBRE>>>>>>>>>>>>>>>>>>>>>>>>>");
			Libro libroEncontrado=AdminServicios.consultarLibroXnombre("ROSA GUADALUPE");
			...
			ArrayList<Prestamo> prestamos1= AdminServicios.mostrarPrestamos();
