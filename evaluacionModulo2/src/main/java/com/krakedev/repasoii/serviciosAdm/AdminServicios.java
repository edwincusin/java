...
public class AdminServicios {
	...
	public static ArrayList<Prestamo> mostrarPrestamos() throws KrakeDevException{
	...
	public static ArrayList<Prestamo> mostrarPrestamosID(int libroIDBuscar) throws KrakeDevException{
		ArrayList<Prestamo> prestamos=new ArrayList<Prestamo>();
		Connection con=null;
		PreparedStatement ps=null;
		ResultSet rs=null;
	...
	public static void insertarLibro(Libro libro) throws KrakeDevException{
		Connection con=null;
		PreparedStatement ps=null;
		Libro libroEncontrado=consultarLibroXnombre(libro.getTitulo());
		...
		try {
			...
			if (libroEncontrado==null) {
				...
				LOGGER.trace("IMPOSIBLE REGISTRAR LIBRO, YA EXISTE UNO CON EL MUSMO NOMBRE"+libro);
			}
			LOGGER.trace("FIN CONSULTA .. >>>>>>>>>>>>>>>>>>");	
