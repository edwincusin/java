package com.krakedev.prestamos.util;
...
public class Convertidor {
	...
	public static Date convertirFecha(String fechaStr) throws Exception {
		...
		try {
			...
			//propagamos el error 
			throw new Exception("LA FECHA NO TIENE FORMATO CORRECTO " +fechaStr);
		}
	...
	public static Date convertirHora(String horaStr) throws Exception {
		...
		try {
			...
			//propagamos el error 
			throw new Exception("LA HORA NO TIENE FORMATO CORRECTO"+horaStr);
		}
